    ...
    : _count(Count)
{
    ...
    GLCall(glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, _rendererID)); // Select the buffer to use with how it`s going to be used
...
{
    GLCall(glDeleteBuffers(1, &_rendererID)); // Deletes the buffer
}
